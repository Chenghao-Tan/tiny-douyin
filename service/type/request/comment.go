...
type CommentReq struct {
	...
	Comment_Text string `json:"comment_text" form:"comment_text" binding:"omitempty,min=1,max=256,startsnotwith= "` // 可选参数，用户填写的评论内容，在action_type=1的时候使用
	Comment_ID   uint   `json:"comment_id" form:"comment_id" binding:"omitempty,min=1"`                             // 可选参数，要删除的评论id，在action_type=2的时候使用
}
